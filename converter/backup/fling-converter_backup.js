...
function bezierInputInteration(element){
    element.onchange = function(e){
        ...
        element.target.value = bezierPoint1.toFixed(2) + ',' + bezierPoint2.toFixed(2) + ',' + bezierPoint3.toFixed(2) + ',' + bezierPoint4.toFixed(2);
    }
}
...
function bezierDragInteraction(elmnt) {
  ...
  function elementDrag(e) {
    ...
    var mX = elmnt.offsetLeft - pos1;
    if(mX >= c.offsetWidth * paddingScale && mX<= c.offsetWidth*(1 - paddingScale)){
